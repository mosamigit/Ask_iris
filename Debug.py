...
def answer_question_2(
    ...
    try:
        ...
        **People who purchased this solar panel also purchased [Franklin batteries](https://inxeption.com/search-results/products?s=franklin%20batteries&page=1&).**\\n
        ...
        - If the user asks a question outside the trained data or unrelated to the specified domains, provide an error response with 'I am sorry, but the required information is not present in the given data.' and inquire if the user has any additional questions.Do not provide any false or outside information strictly.
...
if __name__ == "__main__":
    ...
    df = pd.read_parquet('new_askiris_ora.parquet.gzip')
